...
<html lang="en">
  ...
  <div class="container-fluid"> 
   ...
   <?php 
       ...
       <div class="row">    
           <div class="col-1">
                <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">重新上傳</button>
           ...
           <div class="col-1">
                ...
                <button type="submit" class="btn btn-primary" name="submit">填補</button>
                </form>   
           </div>
           <div class="col">
